...
const ContinueCard = ({data}:{
    ...
    return(
        <div className="fle flex-col gap-2">
            ...
            <Button className="h-auto items-start justify-start p-4 bg-background border rounded-none flex flex-col gap-2" variant="outline" asChild>
            <Link href={`/projects/${data._id}`} className="group">
            <div className="flex items.center justify-between w-full">
                <div className="flex items-center gap-2">{getProjectIcon(data)}
...
export const ProjectList = ({ onViewAll }: ProjectListProps) => {
   const projects = useProjectsPartial(17);
